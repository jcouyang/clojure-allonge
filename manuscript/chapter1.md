...
A> {linenos=off}
A> ~~~~~~~~
A> => "What's your name? I'm fine! thank you! and you?"
A> ~~~~~~~~
...
## 函数!函数!<a id="sec-1-4" name="sec-1-4"></a>
...
## Let<a id="sec-1-5" name="sec-1-5"></a>
...
## loop recur<a id="sec-1-6" name="sec-1-6"></a>
...
## 函数<a id="sec-1-7" name="sec-1-7"></a>
